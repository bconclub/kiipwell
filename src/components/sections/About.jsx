...
export default function About() {
  return (
    <section id="about" aria-labelledby="about-heading" className="bg-white">
      <div className="grid lg:grid-cols-[55fr_45fr] min-h-[600px]">
        <div className="relative overflow-hidden order-2 lg:order-1 min-h-[360px]">
          <img
        ...
        <div className="order-1 lg:order-2 px-6 sm:px-10 lg:px-20 py-16 lg:py-24 flex flex-col justify-center bg-white">
